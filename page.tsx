...
const phoneNumber = "+1 (555) 123-4567"; // TODO: replace
const emailAddress = "hello@groutrestorations.com"; // TODO: replace
  ...
  return (
    <header className="fixed top-0 left-0 w-full bg-white shadow z-50">
      <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
        ...
        <a href={`tel:${phoneNumber.replace(/[^+\d]/g, "")}`} className="flex items-center gap-2 bg-blue-600 text-white px-4 py-2 rounded-2xl shadow">
      ...
      <div className="max-w-5xl mx-auto px-4 grid md:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <ul className="space-y-4">
            <li className="flex items-center gap-2"><Phone className="w-5 h-5 text-blue-600" /> <a href={`tel:${phoneNumber.replace(/[^+\d]/g, "")}`}>{phoneNumber}</a></li>
        ...
        <form className="bg-gray-50 p-6 rounded-2xl shadow space-y-4" action="#" method="POST">
